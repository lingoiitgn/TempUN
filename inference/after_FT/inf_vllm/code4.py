...
parser.add_argument('--base-dir', type=str, default='/home/dkowsik/temporal-dataset/data/micro_dataset/micro_dataset/final_top100_jsons_shrunk_easy_date_based_mcq_prompt', help='Path to the csvs')
parser.add_argument('--out-dir', type=str, default='/home/himanshubeniwal/Dishant/results_ft_llama4', help='Path to the output directory')
