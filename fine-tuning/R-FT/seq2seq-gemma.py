...
parser.add_argument('--model-name', type=str, default='google/gemma-7b-it', help='model name')
parser.add_argument('--base-model-id', type=str, default='google/gemma-7b-it', help='base model id')
...
output_dir = f"/home/singh_shruti/temporal_ft/temporal_ft/models_gemma/{base_model_id}-{ft_type}-finetuned-{datetime.now().strftime('%Y-%m-%d-%H-%M')}"
