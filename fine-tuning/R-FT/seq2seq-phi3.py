...
parser = argparse.ArgumentParser(description='Finetune phi-3 full!')
...
parser.add_argument('--model-name', type=str, default='microsoft/Phi-3-medium-128k-instruct', help='model name')
...
MODEL_OUTPUT_FOLDER = f"models/phi3/{args.start_year}-{args.end_year}"
